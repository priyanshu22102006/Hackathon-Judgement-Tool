                      ...
                      {expandedTeam === t.teamId && (
                        <tr key={`${t.teamId}-detail`}>
                          ...
                          >
                            ...
                            {/* ── Gitignore & Dependency Analysis ── */}
                            {t.integrity?.gitignoreAnalysis && (
                              <div
                                style={{
                                  background: "#161b22",
                                  border: "1px solid #21262d",
                              ...
                              >
                                <h3 style={{ margin: "0 0 12px", fontSize: "0.92rem", color: "#c9d1d9", display: "flex", alignItems: "center", gap: 8 }}>
                                  🔍 Gitignore &amp; Dependency Validation
                                  {t.integrity.gitignoreAnalysis.totalViolatingFiles > 0 && (
                                    <span style={{
                                      ...
                                      {t.integrity.gitignoreAnalysis.totalViolatingFiles} VIOLATION{t.integrity.gitignoreAnalysis.totalViolatingFiles > 1 ? "S" : ""}
                                    </span>
                                  )}
                                  {t.integrity.gitignoreAnalysis.totalViolatingFiles === 0 &&
                                    t.integrity.gitignoreAnalysis.gitignorePresent && (
                                    <span style={{
                                ...
                                <div style={{
                                  ...
                                  <div style={{
                                    ...
                                    <div style={{ fontSize: "0.72rem", color: "#8b949e", marginBottom: 4, textTransform: "uppercase", letterSpacing: "0.5px" }}>
                                      .gitignore
                                    </div>
                                    <div style={{
                                      fontSize: "1rem", fontWeight: 700,
                                      color: t.integrity.gitignoreAnalysis.gitignorePresent ? "#52c41a" : "#f85149",
                                    }}>
                                      {t.integrity.gitignoreAnalysis.gitignorePresent ? "Present" : "Missing"}
                                    </div>
                                  </div>
                                  <div style={{
                                    background: "#0d1117", border: "1px solid #21262d",
                                    ...
                                    <div style={{
                                      fontSize: "1rem", fontWeight: 700,
                                      color: t.integrity.gitignoreAnalysis.totalViolatingFiles > 0 ? "#f85149" : "#52c41a",
                                    }}>
                                      {t.integrity.gitignoreAnalysis.totalViolatingFiles}
                                    </div>
                                  </div>
                                  <div style={{
                                    background: "#0d1117", border: "1px solid #21262d",
                                    ...
                                    <div style={{
                                      fontSize: "1rem", fontWeight: 700,
                                      color: t.integrity.gitignoreAnalysis.suspiciousPatterns.length > 0 ? "#f85149" : "#52c41a",
                                    }}>
                                      {t.integrity.gitignoreAnalysis.suspiciousPatterns.length}
                                    </div>
                                  </div>
                                  <div style={{
                                    background: "#0d1117", border: "1px solid #21262d",
                                    ...
                                    <div style={{ fontSize: "0.72rem", color: "#8b949e", marginBottom: 4, textTransform: "uppercase", letterSpacing: "0.5px" }}>
                                      Commits w/ Violations
                                    </div>
                                    <div style={{
                                      fontSize: "1rem", fontWeight: 700,
                                      color: (t.integrity.gitignoreAnalysis.violationsByCommit?.length || 0) > 0 ? "#d29922" : "#52c41a",
                                    }}>
                                      {t.integrity.gitignoreAnalysis.violationsByCommit?.length || 0}
                                    </div>
                                  </div>
                                </div>

                                {/* Suspicious patterns */}
                                {t.integrity.gitignoreAnalysis.suspiciousPatterns.length > 0 && (
                                  <div style={{
                                    background: "rgba(248,81,73,0.06)",
                                    border: "1px solid rgba(248,81,73,0.2)",
                                    borderRadius: 8, padding: 12, marginBottom: 10,
                                  }}>
                                    <div style={{ fontSize: "0.78rem", fontWeight: 700, color: "#f85149", marginBottom: 6 }}>
                                      ⚠ Suspicious .gitignore Patterns (Hiding Source Code)
                                    </div>
                                    {t.integrity.gitignoreAnalysis.suspiciousPatterns.map((sp, i) => (
                                      <div key={i} style={{ fontSize: "0.8rem", color: "#f0883e", padding: "3px 0", borderBottom: i < t.integrity.gitignoreAnalysis.suspiciousPatterns.length - 1 ? "1px solid rgba(248,81,73,0.1)" : "none" }}>
                                        <code style={{ background: "rgba(248,81,73,0.1)", padding: "1px 6px", borderRadius: 4, fontSize: "0.78rem" }}>{sp.pattern}</code>
                                        <span style={{ marginLeft: 8, color: "#8b949e", fontSize: "0.75rem" }}>{sp.reason}</span>
                                      </div>
                                    ))}
                                  </div>
                                )}
                                ...
                                {/* Violations list */}
                                {t.integrity.gitignoreAnalysis.violations.length > 0 && (
                                  <div style={{
                                    background: "rgba(210,153,34,0.06)",
                                    border: "1px solid rgba(210,153,34,0.2)",
                                    borderRadius: 8, padding: 12, marginBottom: 10,
                                  }}>
                                    <div style={{ fontSize: "0.78rem", fontWeight: 700, color: "#d29922", marginBottom: 6 }}>
                                      🚨 Committed Files Matching .gitignore (Should Be Ignored)
                                    </div>
                                    <div style={{ maxHeight: 200, overflowY: "auto" }}>
                                      {t.integrity.gitignoreAnalysis.violations.slice(0, 50).map((v, i) => (
                                        <div key={i} style={{ fontSize: "0.78rem", color: "#c9d1d9", padding: "3px 0", display: "flex", justifyContent: "space-between", borderBottom: "1px solid #21262d" }}>
                                          <code style={{ color: "#f0883e", fontSize: "0.75rem" }}>{v.file}</code>
                                          <span style={{ color: "#484f58", fontSize: "0.72rem" }}>matched: {v.matchedPattern}</span>
                                        </div>
                                      ))}
                                      {t.integrity.gitignoreAnalysis.violations.length > 50 && (
                                        <div style={{ color: "#484f58", fontSize: "0.75rem", padding: "6px 0", textAlign: "center" }}>
                                          … and {t.integrity.gitignoreAnalysis.violations.length - 50} more
                                        </div>
                                      )}
                                    </div>
                                  </div>
                                ...
                                {/* Per-commit violations */}
                                {(t.integrity.gitignoreAnalysis.violationsByCommit?.length || 0) > 0 && (
                                  <div style={{
                                    background: "#0d1117",
                                    border: "1px solid #21262d",
                                    borderRadius: 8, padding: 12,
                                  }}>
                                    <div style={{ fontSize: "0.78rem", fontWeight: 700, color: "#8b949e", marginBottom: 6 }}>
                                      Commits with Gitignore Violations
                                    </div>
                                    {t.integrity.gitignoreAnalysis.violationsByCommit.map((vc, i) => (
                                      <div key={i} style={{
                                        padding: "8px 0",
                                        borderBottom: i < t.integrity.gitignoreAnalysis.violationsByCommit.length - 1 ? "1px solid #21262d" : "none",
                                      }}>
                                        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
                                          <div>
                                            <code style={{ color: "#58a6ff", fontSize: "0.75rem" }}>{vc.commitHash?.slice(0, 7)}</code>
                                            <span style={{ color: "#c9d1d9", fontSize: "0.8rem", marginLeft: 8 }}>{vc.message?.slice(0, 60)}</span>
                                          </div>
                                          <span style={{
                                            background: vc.violationRatio > 50 ? "rgba(248,81,73,0.15)" : "rgba(210,153,34,0.15)",
                                            color: vc.violationRatio > 50 ? "#f85149" : "#d29922",
                                            fontSize: "0.72rem",
                                            fontWeight: 700,
                                            padding: "2px 8px",
                                            borderRadius: 10,
                                          }}>
                                            {vc.violatingFiles.length}/{vc.totalFiles} files ({vc.violationRatio}%)
                                          </span>
                                        </div>
                                        <div style={{ marginTop: 4, fontSize: "0.72rem", color: "#484f58" }}>
                                          by {vc.author} — {new Date(vc.timestamp).toLocaleString()}
                                        </div>
                                      </div>
                                    ))}
                                  </div>
                                ...
                                {/* Details / issues */}
                                {t.integrity.gitignoreAnalysis.details?.length > 0 && (
                                  <div style={{ marginTop: 10 }}>
                                    {t.integrity.gitignoreAnalysis.details.map((d, i) => (
                                      <div key={i} style={{ fontSize: "0.78rem", color: "#f0883e", padding: "3px 0" }}>
                                        ⚠ {d.issue}
                                      </div>
                                    ))}
                                  </div>
                                ...
                                {t.integrity.gitignoreAnalysis.gitignorePresent &&
                                  t.integrity.gitignoreAnalysis.totalViolatingFiles === 0 &&
                                  t.integrity.gitignoreAnalysis.suspiciousPatterns.length === 0 && (
                                  <div style={{ fontSize: "0.82rem", color: "#52c41a", padding: "6px 0" }}>
                                    ✓ No gitignore violations or suspicious patterns detected. Dependencies appear consistent.
                                  </div>
                                )}
                                {!t.integrity.gitignoreAnalysis.gitignorePresent && (
                                  <div style={{ fontSize: "0.82rem", color: "#d29922", padding: "6px 0" }}>
                                    ⚠ No .gitignore file found — run Deep Analysis to fetch it, or the repo may not have one.
                                  </div>
                                )}
                              </div>
                            )}

                            {/* ── Timestamp Verification Panel ── */}
                            {t.integrity?.timestampVerification && (
                              <div
                                style={{
                                  background: "#161b22",
                                  border: "1px solid #21262d",
                              ...
                              >
                                <h3 style={{ margin: "0 0 12px", fontSize: "0.92rem", color: "#c9d1d9", display: "flex", alignItems: "center", gap: 8 }}>
                                  ...
                                  {t.integrity.timestampVerification.preStartCount > 0 && (
                                    <span style={{
                                      background: "rgba(248,81,73,0.15)",
                                      color: "#f85149",
                                      fontSize: "0.72rem",
                                      ...
                                      {t.integrity.timestampVerification.preStartCount} PRE-START COMMIT{t.integrity.timestampVerification.preStartCount > 1 ? "S" : ""}
                                    </span>
                                  )}
                                  {t.integrity.timestampVerification.preStartCount === 0 &&
                                    t.integrity.timestampVerification.firstCommitTimestamp && (
                                    <span style={{
                                      background: "rgba(82,196,26,0.12)",
                                      color: "#52c41a",
                                      fontSize: "0.72rem",
                                ...
                                <div style={{
                                  ...
                                  <div style={{
                                    ...
                                    <div style={{ fontSize: "0.85rem", fontWeight: 600, color: "#58a6ff" }}>
                                      {t.integrity.timestampVerification.hackathonStartTime
                                        ? new Date(t.integrity.timestampVerification.hackathonStartTime).toLocaleString()
                                        : "—"}
                                    </div>
                                  </div>
                                  <div style={{
                                    background: "#0d1117",
                                    border: `1px solid ${t.integrity.timestampVerification.isFirstCommitBeforeStart ? "rgba(248,81,73,0.4)" : "#21262d"}`,
                                    borderRadius: 8, padding: 12,
                                  }}>
                                    <div style={{ fontSize: "0.72rem", color: "#8b949e", marginBottom: 4, textTransform: "uppercase", letterSpacing: "0.5px" }}>
                                      First Commit
                                    ...
                                    <div style={{
                                      ...
                                      color: t.integrity.timestampVerification.isFirstCommitBeforeStart ? "#f85149" : "#52c41a",
                                    }}>
                                      {t.integrity.timestampVerification.firstCommitTimestamp
                                        ? new Date(t.integrity.timestampVerification.firstCommitTimestamp).toLocaleString()
                                        : "No commits"}
                                    </div>
                                    {t.integrity.timestampVerification.firstCommitAuthor && (
                                      <div style={{ fontSize: "0.72rem", color: "#484f58", marginTop: 2 }}>
                                        by {t.integrity.timestampVerification.firstCommitAuthor}
                                      </div>
                                    )}
                                  </div>
                                  <div style={{
                                    ...
                                    <div style={{
                                      ...
                                      color: t.integrity.timestampVerification.preStartCount > 0 ? "#f85149" : "#52c41a",
                                    }}>
                                      {t.integrity.timestampVerification.preStartCount}
                                    </div>
                                  </div>
                                </div>

                                {/* First commit before start warning */}
                                {t.integrity.timestampVerification.isFirstCommitBeforeStart && (
                                  <div style={{
                                    background: "rgba(248,81,73,0.08)",
                                    border: "1px solid rgba(248,81,73,0.2)",
                                    borderRadius: 8, padding: 12, marginBottom: 10,
                                  }}>
                                    <div style={{ fontSize: "0.82rem", fontWeight: 700, color: "#f85149", marginBottom: 4 }}>
                                      🚨 First Commit Before Hackathon Start
                                    </div>
                                    <div style={{ fontSize: "0.8rem", color: "#f0883e" }}>
                                      The initial commit (<code style={{ background: "rgba(248,81,73,0.1)", padding: "1px 6px", borderRadius: 4, fontSize: "0.75rem" }}>{t.integrity.timestampVerification.firstCommitHash?.slice(0, 7)}</code>) by <strong>{t.integrity.timestampVerification.firstCommitAuthor}</strong> was made BEFORE the official start time.
                                      {t.integrity.timestampVerification.firstCommitMessage && (
                                        <span style={{ display: "block", marginTop: 4, color: "#484f58" }}>
                                          Message: &ldquo;{t.integrity.timestampVerification.firstCommitMessage}&rdquo;
                                        </span>
                                      )}
                                    </div>
                                  </div>
                                ...
                                {/* Pre-start commits list */}
                                {t.integrity.timestampVerification.preStartCommits?.length > 0 && (
                                  <div style={{
                                    background: "#0d1117",
                                    border: "1px solid #21262d",
                                    borderRadius: 8, padding: 12, marginBottom: 10,
                                  }}>
                                    <div style={{ fontSize: "0.78rem", fontWeight: 700, color: "#f85149", marginBottom: 8 }}>
                                      Commits Before Official Start Time
                                    </div>
                                    {t.integrity.timestampVerification.preStartCommits.map((pc, i) => (
                                      <div key={i} style={{
                                        padding: "8px 0",
                                        borderBottom: i < t.integrity.timestampVerification.preStartCommits.length - 1 ? "1px solid #21262d" : "none",
                                        display: "flex",
                                        justifyContent: "space-between",
                                        ...
                                        <div>
                                          <code style={{ color: "#58a6ff", fontSize: "0.75rem" }}>{pc.hash?.slice(0, 7)}</code>
                                          <span style={{ color: "#c9d1d9", fontSize: "0.8rem", marginLeft: 8 }}>{pc.message?.slice(0, 60)}</span>
                                          <div style={{ fontSize: "0.72rem", color: "#484f58", marginTop: 2 }}>
                                            by {pc.author} — {new Date(pc.timestamp).toLocaleString()}
                                          </div>
                                        </div>
                                        <span style={{
                                          ...
                                          {pc.timeBeforeStart} before start
                                        </span>
                                      </div>
                                    ))}
                                  </div>
                                ...
                                {/* Details */}
                                {t.integrity.timestampVerification.details?.length > 0 && (
                                  <div style={{ marginTop: 6 }}>
                                    {t.integrity.timestampVerification.details.map((d, i) => (
                                      <div key={i} style={{ fontSize: "0.78rem", color: "#f0883e", padding: "3px 0" }}>
                                        ⚠ {d.issue}
                                      </div>
                                    ))}
                                ...
                                {t.integrity.timestampVerification.preStartCount === 0 &&
                                  t.integrity.timestampVerification.firstCommitTimestamp && (
                                  <div style={{ fontSize: "0.82rem", color: "#52c41a", padding: "6px 0" }}>
                                    ✓ All commits are within the official hackathon time window.  First commit logged at {new Date(t.integrity.timestampVerification.firstCommitTimestamp).toLocaleString()}.
                                  </div>
                                )}
                              </div>
                            )}
